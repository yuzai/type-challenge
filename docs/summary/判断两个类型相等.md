...
常见的就是联合类型，比如： never，可以参考 [isNever 这一题](/docs/medium/1042-isNever.md)。
...
了解了这个能力，很多题目，[isNever](/docs/medium/1042-isNever.md), [949-AnyOf](/docs/medium/949-AnyOf.md)、[527-AppendToObject](/docs/medium/527-AppendToObject.md) 等题目中的判断就可以用到了。
