...
[medium/4425-实现比较](/medium/4425-实现比较.md) 就是这个套路。
...
- 计数：[medium/298-计算字符的长度](/medium/298-计算字符的长度.md), [medium/9142-CheckRepeatedChars](/medium/9142-CheckRepeatedChars.md), [hard/651-字符长度 2](/hard/651-字符长度2.md)。
