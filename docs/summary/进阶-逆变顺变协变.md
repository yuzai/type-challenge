...
这是 [hard/55 UnionToIntersection](/hard/55-UnionToIntersection.md) 的完整题解，也是几乎所有涉及"联合 → 对象合并""提取联合公共字段""联合转元组末项"等 hard 技巧的基础。
...
- 联合转元组：[hard/730-联合转元组](/hard/730-联合转元组.md), [hard/472-元组转 EnumObject](/hard/472-元组转EnumObject.md)。
